...
syntactic_analyzer_main_executable: syn_main.o syn_functions.o syn_converter.o first.o follow.o ll1pt.o
	gcc syntactic_analyzer/tmp/build/main.o syntactic_analyzer/tmp/build/ll1pt.o syntactic_analyzer/tmp/build/first.o syntactic_analyzer/tmp/build/follow.o syntactic_analyzer/tmp/build/functions.o syntactic_analyzer/tmp/build/converter.o -o syntactic_analyzer/main
...
ll1pt.o: syntactic_analyzer/core/ll1_parsing_table/*
	gcc -c syntactic_analyzer/core/ll1_parsing_table/ll1pt.c -o syntactic_analyzer/tmp/build/ll1pt.o
